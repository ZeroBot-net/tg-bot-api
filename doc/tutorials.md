...
* [@zero-bot.net/tg-bot-api-tutorial by @hosein2398](https://github.com/hosein2398/@zero-bot.net/tg-bot-api-tutorial)
* [@zero-bot.net/tg-bot-api-persian-language by @saeedhei](https://github.com/saeedhei/@zero-bot.net/tg-bot-api-persian-language)
...
* [@zero-bot.net/tg-bot-api-tutorial:a telegram bot helper to send templates by sms](https://github.com/vito2005/chatManagerTelegramBot)
* [Telegram bot using blockchain services](https://ilanolkies.com/post/Telegram-bot-using-blockchain-services)
* [How to set webhooks using express local server and NGROK](https://github.com/leobloise/@zero-bot.net/tg-bot-api-wb-tutorial)
