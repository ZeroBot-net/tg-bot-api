...
var debug = require('debug')('@zero-bot.net/tg-bot-api');
var EventEmitter = require('eventemitter3');
var fileType = require('file-type');
var requestBase = require('@zero-bot.net/request');
var request = function request(options) { return new Promise(function (resolve, reject) { requestBase(options, function (err, response) { if (err) reject(err); else resolve(response); }); }); };
var streamedRequest = requestBase;
...
var TelegramBot = function (_EventEmitter) {
  ...
  _createClass(TelegramBot, [{
    ...
    value: function on(event, listener) {
      if (_deprecatedMessageTypes.indexOf(event) !== -1) {
        var url = 'https://github.com/ZeroBot-net/@zero-bot.net/tg-bot-api/blob/master/doc/usage.md#events';
  ...
  _createClass(TelegramBot, [{
    ...
    value: function _formatSendData(type, data) {
      ...
      var deprecationMessage = 'See https://github.com/ZeroBot-net/@zero-bot.net/tg-bot-api/blob/master/doc/usage.md#sending-files' + ' for more information on how sending files has been improved and' + ' on how to disable this deprecation message altogether.';
      var filedata = data;
